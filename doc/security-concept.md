...
- [General approach](#general-approach)
  ...
  - [Policy triggers - governance rules for up-leveling](#policy-triggers---governance-rules-for-up-leveling)
    - [Suggested triggers for mandating Level 2 (private_key_jwt)](#suggested-triggers-for-mandating-level-2-private-key-jwt)
...
- [Client onboarding](#client-onboarding)
  ...
  - [Validation architecture (gateway + policy engine responsibilities)](#validation-architecture-gateway-b-policy-engine-responsibilities)
