...
KRAKEND_PLACER_URL="${APISIX_PLACER_URL:-${KRAKEND_PLACER_URL:-http://localhost:8080}}"
KRAKEND_PLACER_EXT_URL="${APISIX_PLACER_EXT_URL:-${KRAKEND_PLACER_EXT_URL:-http://localhost:8081}}"
...
wait_for "APISIX Placer"          "${KRAKEND_PLACER_URL}/__health"
wait_for "APISIX Placer Ext"      "${KRAKEND_PLACER_EXT_URL}/__health"
wait_for "APISIX Fulfiller"       "${KRAKEND_FULFILLER_URL}/__health"
wait_for "APISIX Fulfiller Ext"   "${KRAKEND_FULFILLER_EXT_URL}/__health"
